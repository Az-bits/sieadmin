/**
 * Script principal de cuentas usuario
 */
...
$(document).ready(function () {
    ...
    btnState = {
        add: function () {
            modalTitle.innerHTML = 'FORMULARIO DE CUENTAS DE USUARIOS';
            $(btnSubmit).removeAttr('data-id-soft');
            $(btnTextSubmit).text('CREAR FORMULARIO');
        },
        edit: function (id) {
            modalTitle.innerHTML = 'EDITAR FORMULARIO DE CUENTAS DE USUARIOS';
